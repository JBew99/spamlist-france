...
import { Search, Monitor, Zap, ChevronRight, Loader2 } from "lucide-react";
...
export default function ListPage() {
  ...
  const { data: levels, loading } = useCollection(levelsQuery);
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-6">
          <div>
            <h1 className="text-4xl font-black gold-text mb-2 uppercase">Archives de la Liste</h1>
            <p className="text-muted-foreground">Le standard technique de l'élite française.</p>
          </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-24 text-primary">
            ...
            <p className="font-bold silver-text uppercase tracking-widest">Chargement de la liste...</p>
          </div>
        ) : (
          <div className="grid gap-4">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge variant="outline" className="text-[10px] uppercase font-bold">{level.spamType}</Badge>
                      </div>
            ...
            {filteredLevels.length === 0 && (
              <div className="text-center py-20 border-2 border-dashed border-border rounded-2xl">
                <p className="text-muted-foreground italic text-lg">Aucun niveau ne correspond à vos filtres.</p>
              </div>
            )}
          </div>
        )}
